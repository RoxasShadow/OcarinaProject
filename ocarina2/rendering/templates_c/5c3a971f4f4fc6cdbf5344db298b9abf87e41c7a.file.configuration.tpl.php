<?php /* Smarty version Smarty-3.0.8, created on 2011-07-08 22:04:01
         compiled from "/var/www/htdocs/ocarina2/rendering/templates/admin/configuration.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20331868884e177ed14c3a19-94984878%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5c3a971f4f4fc6cdbf5344db298b9abf87e41c7a' => 
    array (
      0 => '/var/www/htdocs/ocarina2/rendering/templates/admin/configuration.tpl',
      1 => 1310162640,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '20331868884e177ed14c3a19-94984878',
  'function' => 
  array (
  ),
...
"<?php }?> /><br /><br />
		Cookie<br />
		<input type="text" name="log" maxlength="20" <?php if ((isset($_smarty_tpl->getVariable('cookie_default',null,true,false)->value))){?>value="<?php echo $_smarty_tpl->getVariable('cookie_default')->value;?>
"<?php }?> /><br /><br />
		Skin<br />
		<select name="skin">
...
"<?php }?> /><br /><br />
		Limite news<br />
		<input type="text" name="description" maxlength="10" <?php if ((isset($_smarty_tpl->getVariable('description_default',null,true,false)->value))){?>value="<?php echo $_smarty_tpl->getVariable('description_default')->value;?>
"<?php }?> /><br /><br />
		Impaginazione news<br />
